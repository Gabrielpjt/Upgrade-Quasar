  ...
  <q-layout view="hHh Lpr fFf" style="background:#EEF1F5;">
    ...
    >
      <q-toolbar :class="$q.platform.is.mobile ? 'channel-toolbar q-mr-xs' : 'channel-toolbar'">
        ...
        <div :class="$route.name === 'v2-dashboard' ? 'toolbar-button-active-underline' : ''">
          <q-btn no-caps style="width:78px" round flat stack
            :class="$route.name === 'v2-dashboard' ? 'toolbar-button-active' : 'toolbar-button'"
            class="kmp-normal-text kmp-black-text kmp-new-font"
            @click="$router.push({ name: 'v2-dashboard' })"
          >
            <Icon icon="mingcute:home-5-line" width="24" height="24" />
              <div class="q-mt-xs" >Home Page</div>
          </q-btn>
        </div>
        <div :class="$route.name === 'v2-library' || $route.name === 'v2-library-detail'  ? 'toolbar-button-active-underline' : ''">
          <q-btn no-caps style="width:78px" round flat stack
            :class="$route.name === 'v2-library' || $route.name === 'v2-library-detail' ? 'toolbar-button-active' : 'toolbar-button'"
          class="toolbar-button kmp-normal-text kmp-black-text kmp-new-font"
          @click="$router.push({ name: 'v2-library' })"
          >
        ...
        <div :class="$q.platform.is.mobile ? 'q-gutter-sm' : 'toolbar-padding'">
          <q-btn @click="$router.push({ name: 'training' })" no-caps style="width:78px" round flat stack class="toolbar-button kmp-normal-text kmp-black-text kmp-new-font">
            <q-icon center size="22px" name="o_local_library"  />
              <div class="q-mt-xs">Training</div>
          </q-btn>
        </div>
        <div :class="$q.platform.is.mobile ? 'q-gutter-sm' : 'toolbar-padding'">
          <q-btn @click="$router.push({ name: 'channel-detail', params: { id: 39 } })" no-caps style="width:78px" round flat stack class="toolbar-button kmp-normal-text kmp-black-text kmp-new-font">
            <Icon icon="ion:chatbubbles-outline" width="24" height="24" />
              <div class="q-mt-xs">Channel</div>
          </q-btn>
        </div>
        <div :class="$q.platform.is.mobile ? 'q-gutter-sm' : 'toolbar-padding'">
          <q-btn @click="$router.push({ name: 'knowledge' })" no-caps style="width:78px" round flat stack class="toolbar-button kmp-normal-text kmp-black-text kmp-new-font">
                ...
                <!-- <div class="q-pa-md"> -->
                  <q-item  style="border-radius: 4px;" dense class="q-pa-none q-mb-sm">
                    ...
                    <q-item-section class="q-pa-none kmp-black-text">
                      ...
                      <q-item-label class="kmp-xs-text kmp-normal-text kmp-line-125">{{ user.unit_kerja }}</q-item-label>
                      <q-item-label class="text-orange-7" style="font-size: 11px;">
